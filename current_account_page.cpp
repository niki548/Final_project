...
#include "ui_current_account_page.h"
#include "List.h"
#include "admin_page.h"
#include <QMessageBox>

Current_account_page::Current_account_page(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Current_account_page)
{
    ui->setupUi(this);
...
void Current_account_page::on_pushButton_clicked()
{
    ...
    newcostumer->newcostumer.BList->pushback(card_number, shaba_number, account_number, cvv2, cash, expiration_date,
...
void Current_account_page::on_toolButton_clicked()
{
