...
#include "ui_diposit_account_page.h"
#include "List.h"
#include "admin_page.h"
#include <QMessageBox>
//#include <QWidgetItem>

diposit_account_page::diposit_account_page(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::diposit_account_page)
{
    ui->setupUi(this);
...
diposit_account_page::~diposit_account_page()
{
    delete ui;
}

void diposit_account_page::on_pushButton_clicked()
{
    ...
    newcostumer->newcostumer.DList->pushback(card_number, shaba_number, account_number, cvv2, cash, expiration_date,
...
void diposit_account_page::on_toolButton_clicked()
{
