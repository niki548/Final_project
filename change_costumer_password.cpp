...
#include "ui_change_costumer_password.h"
#include "List.h"
#include <QListWidgetItem>
#include "costumer_page.h"
#include <QMessageBox>

change_costumer_password::change_costumer_password(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::change_costumer_password)
{
    ui->setupUi(this);
...
change_costumer_password::~change_costumer_password()
{
    delete ui;
}

void change_costumer_password::on_pushButton_current_clicked()
{
...
void change_costumer_password::on_pushButton_loan_clicked()
{
...
void change_costumer_password::on_pushButton_deposit_clicked()
{
...
void change_costumer_password::on_pushButton_clicked()
{
    ...
    if(citem){
        if(type == "current"){
            ...
            ui->lineEdit_first->setText(QString::fromStdString(Baccount->newAccount.getPin()));
        }
            ...
            ui->lineEdit_first->setText(QString::fromStdString(Laccount->newAccount.getPin()));
        }
            ...
            ui->lineEdit_first->setText(QString::fromStdString(Daccount->newAccount.getPin()));
        }
    }
...
void change_costumer_password::on_toolButton_clicked()
{
...
void change_costumer_password::on_toolButton_2_clicked()
{
...
void change_costumer_password::on_pushButton_2_clicked()
{
    ui->listWidget->clear();
}
